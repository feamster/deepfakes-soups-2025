...
\label{sec:cfa}
If generative AI and AI-generated content are becoming part of the foundational infrastructure of the online information ecosystem, then governing it cannot stop at mitigating explicit harm, such as detecting and removing deepfakes, moderating AI-generated misinformation, and labeling binary whether the content is AI-generated or not.  Building on our review of the current governance framework (Section \ref{}) and discussion on why such a framework should be extend (Section \ref{}), we outline an agenda for online platforms, AI developers and providers, regulators and researchers to address challenges on how the surge of AI-generated content reshape user experience, creator rights and community value. Rather than replacing existing measures, our recommendations aim to extend them towards a more proactive, ecosystem-oriented governance of AI-generated content.

\subsection{Recommendation for Online Platforms}
...
\subsection{Recommendation for AI Developers and Service Providers}
...
\subsection{Recommendation for Regulators}
